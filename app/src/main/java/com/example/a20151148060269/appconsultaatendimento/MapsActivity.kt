...
import com.example.a20151148060269.appconsultaatendimento.Common.Common
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var mMap: GoogleMap
     ...
     private var latidude:Double=0.toDouble()
    ...
    private fun nearByPlace(typePlace: String) {
        ...
        val url = getUrl(latidude,longitude,typePlace)
    ...
    private fun getUrl(latidude: Double, longitude: Double, typePlace: String): String {

        val googlePlaceUrl = StringBuilder("https://maps.googleapis.com/maps/api/place/nearbysearch/json")
        googlePlaceUrl.append("?location=$latidude,$longitude")
        googlePlaceUrl.append("&radius=10000") //10km de abrangência
        googlePlaceUrl.append("&type=$typePlace")
        googlePlaceUrl.append("&key=AIzaSyCaGrflP-q560A5RX3Bw3cXFlQ2VMDj7dg")
    ...
    private fun buildLocationCallBack() {
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(p0: LocationResult?) {
                ...
                val latLng = LatLng(latidude, longitude)
                val markerOptions = MarkerOptions()
                        .position(latLng)
                        .title("Sua Posição")
